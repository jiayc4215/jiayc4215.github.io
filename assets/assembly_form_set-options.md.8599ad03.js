import{_ as y}from"./chunks/el-form-renderer.7dd73455.js";import{_ as i,h as u,a0 as F,C as q,o as e,c as t,H as l,w as o,F as g,a as c,p as m,m as d,k as n,Q as _}from"./chunks/framework.ce0e3599.js";import"./chunks/commonjsHelpers.725317a4.js";const h=s=>(m("data-v-84f23cc6"),s=s(),d(),s),C=h(()=>n("div",{class:"box"},"set-options",-1)),f={__name:"setoptios",setup(s){const a=u(),p=F([{id:"area",type:"select",label:"select",el:{placeholder:"select"},options:[{label:"shanghai",value:"shanghai"},{label:"beijing",value:"beijing"}]}]),r=()=>{a.value.setOptions("area",[{label:"guangzhou",value:"guangzhou"},{label:"hangzhou",value:"hangzhou"}])};return(x,z)=>{const E=q("el-button");return e(),t(g,null,[C,l(y,{ref_key:"form",ref:a,content:p},{default:o(()=>[l(E,{onClick:r},{default:o(()=>[c("set")]),_:1})]),_:1},8,["content"])],64)}}},b=i(f,[["__scopeId","data-v-84f23cc6"]]),v=n("h1",{id:"set-options",tabindex:"-1"},[c("set-options "),n("a",{class:"header-anchor",href:"#set-options","aria-label":'Permalink to "set-options"'},"​")],-1),B=n("br",null,null,-1),A=_(`<details class="details custom-block"><summary>查看源代码</summary><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
