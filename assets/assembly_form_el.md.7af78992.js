import{_ as t}from"./chunks/el-form-renderer.7dd73455.js";import{a0 as c,o as a,c as l,H as p,F as r,k as s,a as E,Q as y}from"./chunks/framework.ce0e3599.js";import"./chunks/commonjsHelpers.725317a4.js";const i=s("div",{class:"box"},"el",-1),u=s("div",null," 可以对表单组件传入 props，使用 el 传入 例如配合 el-input，设置文本框 ",-1),d={__name:"el",setup(o){const n=c([{id:"document",type:"input",el:{type:"textarea"}}]);return(e,v)=>(a(),l(r,null,[i,u,p(t,{content:n},null,8,["content"])],64))}},m=s("h1",{id:"el",tabindex:"-1"},[E("el "),s("a",{class:"header-anchor",href:"#el","aria-label":'Permalink to "el"'},"​")],-1),_=s("br",null,null,-1),F=y(`<details class="details custom-block"><summary>查看源代码</summary><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">&lt;</span><span style="color:#85E89D;">template</span><span style="color:#E1E4E8;">&gt;</span></span>
