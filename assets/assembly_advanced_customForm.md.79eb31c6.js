import{_ as s,o as n,c as e,Q as a}from"./chunks/framework.52b122f8.js";const q=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"assembly/advanced/customForm.md","filePath":"assembly/advanced/customForm.md"}'),l={name:"assembly/advanced/customForm.md"},p=a(`<h3 id="前言" tabindex="-1">前言 <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言&quot;">​</a></h3><p>el-form-renderer 的 type 有限, 默认只能渲染普通的表单项, 假如现在要渲染一个上传组件, type 就不够用了, 那怎么办呢? 这时候 component 选项就派上用场了</p><p>本文将介绍如何开发符合 el-form-renderer 接入标准的自定义组件, 实现对自定义组件的渲染</p><h3 id="接入标准" tabindex="-1">接入标准 <a class="header-anchor" href="#接入标准" aria-label="Permalink to &quot;接入标准&quot;">​</a></h3><p>自定义组件接入的关键是在组件内部实现 v-model</p><p>建议在自定义组件上绑定 $attrs</p><p>el-form-renderer 对 v-model 的要求是:</p><ul><li>有一个 props 为 modelValue</li><li>对外触发 update:modelValue 事件</li></ul><p>下面是一个简单的例子</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">&lt;template&gt;</span></span>
